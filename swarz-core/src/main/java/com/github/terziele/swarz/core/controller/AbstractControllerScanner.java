...
abstract class AbstractControllerScanner implements ControllerScanner {
  ...
  protected AbstractControllerScanner(@NonNull ClassLoader classLoader) throws Exception {
    this.classLoader = classLoader;
    this.restControllerAnnotation =
        (Class<? extends Annotation>)
            Class.forName(RestController.class.getCanonicalName(), false, classLoader);
  }
